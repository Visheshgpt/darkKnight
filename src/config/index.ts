...
// 20 KNIGHT per block is sent to Burn pool (A farm just for burning cake)
// 10 KNIGHT per block goes to CAKE syrup pool
// 9 KNIGHT per block goes to Yield farms and lottery
...
export const BASE_URL = 'https://app.knightswap.financial'
