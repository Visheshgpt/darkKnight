...
const LockedStakingApy: React.FC<React.PropsWithChildren<LockedStakingApyProps>> = ({
  ...
  const earningTokenBalance = useMemo(() => {
    return getBalanceNumber(currentLockedAmountAsBigNumber.minus(userData?.knightAtLastUserAction))
  }, [currentLockedAmountAsBigNumber, userData?.knightAtLastUserAction])
