...
export const getCakeVaultEarnings = (
  ...
  const hasAutoEarnings = account && knightAtLastUserAction?.gt(0) && userShares?.gt(0)
  const { cakeAsBigNumber } = convertSharesToCake(userShares, pricePerFullShare)
  const autoCakeProfit = cakeAsBigNumber.minus(fee || BIG_ZERO).minus(knightAtLastUserAction)
