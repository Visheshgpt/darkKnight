 ...
 * https://twitter.com/KnightSwap/status/1523913527626702849
...
const CakeDataRow = () => {
  ...
  console.log('cake', cakePriceBusd.toString())
  ...
  return (
    <Grid>
      ...
      <StyledColumn noMobileBorder style={{ gridArea: 'c' }}>
        <Text color="textSubtle">$dKNIGHT Price</Text>

        <Heading scale="lg">${cakePriceBusd.toString()}</Heading>
      </StyledColumn>
