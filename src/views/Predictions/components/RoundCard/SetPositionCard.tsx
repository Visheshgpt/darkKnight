...
const SetPositionCard: React.FC<React.PropsWithChildren<SetPositionCardProps>> = ({
  ...
  const { isVaultApproved, setLastUpdated } = useCakeApprovalStatus(token.symbol === 'KNIGHT' ? predictionsAddress : null)
  ...
  const handleEnterPosition = async () => {
    ...
    const args = token.symbol === 'KNIGHT' ? [epoch, valueAsBn.toString()] : [epoch]
