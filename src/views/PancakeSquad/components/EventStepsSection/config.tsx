  ...
  return [
    {
      ...
      bodyText: [t('You’ll need an active KnightSwap Profile to buy Minting Tickets and mint a Pancake Squad NFT!')],
      buttons: (
        <>
    ...
    },
    {
      ...
      buttons: (
        <>
          <Button
            as="a"
            href="https://app.knightswap.financial/swap?outputCurrency=0xD23811058Eb6e7967D9a00dc3886E75610c4AbBa&chainId=56"
            target="_blank"
            width="100%"
          >
            {t('Buy dKnight')}
