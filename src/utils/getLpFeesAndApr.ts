...
export const getDailyLpFeesAndApr = (volume24USD: number, liquidityUSD: number) => {
  const totalFees24h = volume24USD * TOTAL_FEE
  const totalFees1y = totalFees24h * 365
 
  return (totalFees1y/liquidityUSD)*100
}
