...
import { useGetChainName, usePoolDatasSWR, useTokenDatasSWR, useTokenDatasSWR2 } from 'state/info/hooks'
...
const useFetchSearchResults = (
  ...
  const tokenDatasFull = useTokenDatasSWR2(searchResults.tokens)
