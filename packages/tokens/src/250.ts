...
export const FantomTokens = {
  ...
  weth: new Token(ChainId.fantomOpera, '0x74b23882a30290451A17c44f4F05243b6b58C76d', 18, 'WETH', 'WETH Token', '#'),
  wbtc: new Token(ChainId.fantomOpera, '0x321162cd933e2be498cd2267a90534a804051b11', 8, 'WBTC', 'WBTC Token', '#'),
