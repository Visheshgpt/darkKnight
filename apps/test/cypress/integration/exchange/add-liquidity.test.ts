describe('Add Liquidity', () => {
  ...
  it('redirects /add/token-token to add/token/token', () => {
    ...
    cy.url().should(
      'contain',
      '/add/0xD23811058Eb6e7967D9a00dc3886E75610c4AbBa/0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56',
    )
  })

  it('redirects /add/BNB-token to /add/BNB/token', () => {
    cy.visit('/add/BNB-0xD23811058Eb6e7967D9a00dc3886E75610c4AbBa')
    cy.url().should('contain', '/add/BNB/0xD23811058Eb6e7967D9a00dc3886E75610c4AbBa')
  })

  it('redirects /add/token-BNB to /add/token/BNB', () => {
    cy.visit('/add/0xD23811058Eb6e7967D9a00dc3886E75610c4AbBa-BNB')
    cy.url().should('contain', '/add/0xD23811058Eb6e7967D9a00dc3886E75610c4AbBa/BNB')
  })
  ...
  it('redirects /add/WBNB to /add/WBNB/token', () => {
    ...
    cy.url().should(
      'contain',
      '/add/0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c/0xD23811058Eb6e7967D9a00dc3886E75610c4AbBa',
    )
  })

  it('redirects /add/token-WBNB to /add/token/WBNB', () => {
    cy.visit('/add/0xD23811058Eb6e7967D9a00dc3886E75610c4AbBa-0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c')
    cy.url().should(
      'contain',
      '/add/0xD23811058Eb6e7967D9a00dc3886E75610c4AbBa/0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c',
    )
  })
})
